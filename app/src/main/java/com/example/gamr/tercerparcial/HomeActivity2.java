...
public class HomeActivity2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Res_Estacion) {
            fragment = new FragmentRegistrar();
            fragmentSeleccionado=true;
        } else if (id == R.id.Bus_Estacion) {
            fragment = new FragmentConsultar();
            fragmentSeleccionado=true;
        } else if (id == R.id.Act_Estacion) {
            fragment = new FragmentActualizar();
            fragmentSeleccionado=true;
        } else if (id == R.id.Eli_Estacion) {
        ...
        if(fragmentSeleccionado == true){
            getSupportFragmentManager().beginTransaction().replace(R.id.content_home2,fragment).commit();
        }
